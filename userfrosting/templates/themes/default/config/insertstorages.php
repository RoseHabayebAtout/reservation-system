...
if (isset($_FILES['userfile']) && $_FILES['userfile']['size'] > 0) {
    ...
    $success_message = 'All storages have been uploaded successfully!';
...
//echo print_r($worksheet->getCell('I1')->getValue());
    ...
    for ($row = 2; $row <= $lastRow; $row++) {
         ...
         */
        $sql_query = "INSERT INTO `storages`( `rawabi_code`, `neighporhood`, `tabu_code`, `building`, `floor`, `storage_number`, `tabu_description`, `area`, `price`) VALUES
