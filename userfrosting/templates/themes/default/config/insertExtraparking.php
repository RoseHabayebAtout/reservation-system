...
if ($back_url == "") {
    $back_url = "http://$_SERVER[HTTP_HOST]/$urlInPieces[1]/public/uploadExtraParking/";
}
...
if (isset($_FILES['userfile']) && $_FILES['userfile']['size'] > 0) {
    ...
    $success_message = 'All extra parkings have been uploaded successfully!';
...
//echo print_r($worksheet->getCell('I1')->getValue());
    ...
    for ($row = 2; $row <= $lastRow; $row++) {
        ...
        //echo print_r("NH" . $row . ":" . $neighborhood . ",");
    ...
    for ($row = 2; $row <= $lastRow; $row++) {
         ...
         */
        $sql_query = "INSERT INTO `extra_parking`(`rawabi_code`, `neighporhood`, `building`, `floor`, `parking_number`, `description`, `price`) VALUES
